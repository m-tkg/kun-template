...
/// 公開 GitHub API（api.github.com）へアクセスし、リリースの取得・ダウンロードを行う。
struct UpdateService {
    static let repoFullName = "m-tkg/newkun"
    static let apiBase = "https://api.github.com"
    private static let userAgent = "Newkun"
    ...
    func downloadReleaseZip(_ release: ReleaseInfo, into directory: URL) async throws -> URL {
        ...
        let destination = directory.appendingPathComponent("Newkun.zip")
